...
class WeekData {
	...
	public static function reloadWeekFiles(isStoryMode:Null<Bool> = false)
	{
		...
		var modsListPath:String = Paths.getPreloadPath 'modsList.txt';
		var directories:Array<String> = [Paths.mods(), Paths.getPreloadPath Paths.getPreloadPath()];
		...
		var sexList:Array<String> = CoolUtil.coolTextFile(Paths.getPreloadPath Paths.getPreloadPath('weeks/weekList.txt'));
	...
	public static function loadTheFirstEnabledMod()
	{
		...
		#if MODS_ALLOWED
		if (FileSystem.exists(Paths.getPreloadPath "modsList.txt"))
		{
			var list:Array<String> = CoolUtil.listFromString(File.getContent(Paths.getPreloadPath "modsList.txt"));
